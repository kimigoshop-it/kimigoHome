<template>
  <div class="headers">
    <header class="headerTop w">
      ...
      <div class="routesty">
        <div>
          <router-link v-for="(item, index) in routerdata" :key="item.id" :to="item.path"
            :class="active === index ? 'bott' : ''" :style="{ borderBottom: routerjjfaFlag ? 'none' : '' }"
...
const clickactive = (index: any) => {
  const pathList = ['/home/index#home', '/home/index#jjfa', '/home/index#gywm', '/home/index#lxwm']
