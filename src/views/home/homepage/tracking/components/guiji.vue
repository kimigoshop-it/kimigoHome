    ...
    <div class="boxconten">
      <div class="guiji" v-for="(item, index) in lists.data" :key="index">
        ...
        <div>
          ...
          <div>
            <img :src="item.officialWebsiteUrl" v-if="item.customerCode !='10008' && item.customerCode !='10009' && item.officialWebsiteUrl !== null"/>
          </div>
...
//马耳他订单 切换本地配置到英文
const switchToMaltese = () => {
  locale.value = 'en'; // 切换到马耳他语言
  localStorage.setItem('lang', 'en'); // 保存到本地存储
};
const {t} = useI18n();
      ...
      data.data.data.forEach((item: any) => {
        item.officialWebsiteRoutingEntities.push({
          ...
          customerOrderRoutingEntities: [
            ...
            //   customerRoutingNodeLanguageName: t('home.track.order_was_success'),
            ...
            //   customerRoutingNodeEnglishName: t('home.track.order_was_success'),
            //   customerRoutingNodeMongoliaName: t('home.track.order_was_success'),
            // },
            {
