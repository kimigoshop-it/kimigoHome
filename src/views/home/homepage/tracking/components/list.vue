    ...
    <div class="boxconten">
        ...
        >
            <div
                class="toptit"
                :style="{
                    borderBottom: !item.show ? '' : '.0625rem solid #e7e7e7',
                }"
                ...
                <div class="childtwo">
                    <div>
                        <n-button
                            :style="{
                                opacity:
                                    item.officialWebsiteOrder === 4 ? '1' : '0',
                            }"
                            strong
                            secondary
                            type="warning"
            ...
            <div
                class="boxtrins"
                :style="{
                    height: !item.show ? '0px' : 'fit-content',
                    transition: 'all .5s',
                }"
            >
                <div>
                    ...
                    <n-scrollbar style="max-height: 306px">
                        ...
                        >
                            <n-button secondary type="warning">
                                ...
                                {{
                                    $t(
                                        "home.track.options_type_" +
                                            options[
                                                childitema
                                                    .officialWebsiteOrderStatus
                                            ].value
                                    )
                                }}
                            </n-button>
                                ...
                                >
                                    <div class="iconsty">
                                        ...
                                        <svg-icon
                                            ...
                                            v-if="
                                                index === 0 &&
                                                childitema.officialWebsiteOrderStatus ===
                                                    0
                                            "
                                        />
                                        <svg-icon
                                    ...
                                    <div class="particulars">
                                        <div v-if="lang == 0">
                                            {{
                                                childite.customerRoutingNodeChineseName
                                            }}
                                        </div>
                                        <div v-if="lang == 1">
                                            {{
                                                childite.customerRoutingNodeRussiaName
                                            }}
                                        </div>
                                        <div v-if="lang == 2">
                                            {{
                                                childite.customerRoutingNodeKazakhstanName
                                            }}
                                        </div>
                                        <span>{{
                                            childite.operateDatetime
                                        }}</span>
                                    </div>
                                </div>
                            </div>
            ...
            data.data.data.forEach((item: any) => {
                item.officialWebsiteRoutingEntities.push({
                    ...
                    customerOrderRoutingEntities: [
                        {
                            customerRoutingNodeChineseName: t(
                                "home.track.order_was_success"
                            ),
                            customerRoutingNodeRussiaName: t(
                                "home.track.order_was_success"
                            ),
                            customerRoutingNodeKazakhstanName: t(
                                "home.track.order_was_success"
                            ),
                        },
                    ],
                ...
                if (item.officialWebsiteOrder === 7) {
                    ...
                    item.officialWebsiteRoutingEntities.unshift({
                        ...
                        customerOrderRoutingEntities: [
                            {
                                customerRoutingNodeChineseName: t(
                                    "home.track.order_was_cancelled"
                                ),
                                customerRoutingNodeRussiaName: t(
                                    "home.track.order_was_cancelled"
                                ),
...
@media (max-width: 999px) {
    ...
    .guiji .boxtrins > :nth-child(1) {
        width: 100%;
    }

    .guiji .boxtrins > :nth-child(2) {
        width: 100%;
    }

    .guiji .toptit .childtwo > :nth-child(2) {
        margin-left: 1.5rem;
    }

    .guiji .toptit .childone > :nth-child(2) {
        flex-wrap: wrap;
        justify-content: center;
        gap: 12px;
    }
